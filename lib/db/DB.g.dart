...
class $GameTemplateConfigTable extends GameTemplateConfig
  ...
  @override
  late final GeneratedColumn<bool> delete = GeneratedColumn<bool>('delete', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: false,
      defaultConstraints: GeneratedColumn.constraintIsAlways('CHECK ("delete" IN (0, 1))'),
      defaultValue: const Constant(false));

  @override
  List<GeneratedColumn> get $columns => [id, name, playerCount, roleConfig, extraRule, weight, createTime, delete];
  ...
  VerificationContext validateIntegrity(Insertable<GameTemplateConfigEntity> instance, {bool isInserting = false}) {
    ...
    if (data.containsKey('delete')) {
      context.handle(_deleteMeta, delete.isAcceptableOrUnknown(data['delete']!, _deleteMeta));
    }
    return context;
  }
...
class $$GameTemplateConfigTableFilterComposer extends Composer<_$AppDatabase, $GameTemplateConfigTable> {
  ...
  ColumnFilters<bool> get delete =>
      $composableBuilder(column: $table.delete, builder: (column) => ColumnFilters(column));
}
...
class $$GameTemplateConfigTableOrderingComposer extends Composer<_$AppDatabase, $GameTemplateConfigTable> {
  ...
  ColumnOrderings<bool> get delete =>
      $composableBuilder(column: $table.delete, builder: (column) => ColumnOrderings(column));
}
...
class $$GameTemplateConfigTableAnnotationComposer extends Composer<_$AppDatabase, $GameTemplateConfigTable> {
  ...
  GeneratedColumn<bool> get delete => $composableBuilder(column: $table.delete, builder: (column) => column);
}
