...
SheriffTools _$SheriffToolsFromJson(Map<String, dynamic> json) => SheriffTools.forJson(
      (json['list'] as List<dynamic>).map((e) => SheriffAction.fromJson(e as Map<String, dynamic>)).toList(),
      isYesSheriffPlayer: json['isYesSheriffPlayer'] as bool? ?? false,
      yesSheriffRound: (json['yesSheriffRound'] as num?)?.toInt() ?? 0,
    );

Map<String, dynamic> _$SheriffToolsToJson(SheriffTools instance) => <String, dynamic>{
      'list': instance.list,
      'isYesSheriffPlayer': instance.isYesSheriffPlayer,
      'yesSheriffRound': instance.yesSheriffRound,
    };

SheriffAction _$SheriffActionFromJson(Map<String, dynamic> json) => SheriffAction.forJson(
...
Map<String, dynamic> _$SheriffActionToJson(SheriffAction instance) => <String, dynamic>{
